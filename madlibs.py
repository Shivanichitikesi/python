...
root.title("Madlibs Generator by Shivani Chitikesi")

Label(root,text='Madlibs',font='arial 50 bold').pack()
Label(root,text='Select any Story',font='arial 20 bold').place(x=270,y=100)
...
Button(root,text='Apple and Apple',font='arial 13 bold',command=madlib1).place(x=100,y=170)

Button(root,text='The Photograher',font='arial 13 bold',command=madlib2).place(x=300,y=170)

Button(root,text='The Butterfly',font='arial 13 bold',command=madlib3).place(x=500,y=170)
